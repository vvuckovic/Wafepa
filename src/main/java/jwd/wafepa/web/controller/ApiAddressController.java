...
public class ApiAddressController {
	...
	public ResponseEntity<List<KategorijaDTO>> get(@PathVariable Long userId) {
	...
	public ResponseEntity<KategorijaDTO> add(
			@RequestBody @Validated KategorijaDTO newAddress,
			@PathVariable Long userId) {
	...
	public ResponseEntity<KategorijaDTO> edit(@PathVariable Long id,
			@RequestBody @Validated KategorijaDTO editedAddress,
			@PathVariable Long userId) {
